export default function Footer() {
  return (
    <footer className="relative bg-slate-950 text-slate-400 border-t border-slate-800/80 py-12">
          ...
          <div className="space-y-3 max-w-md">
            <div className="flex items-center gap-2.5">
              ...
              <div className="text-white font-black text-lg tracking-tight leading-none">
                GSTU <span className="text-blue-400 text-xs font-bold tracking-widest ml-1">CSE HACKATHON</span>
              </div>
            </div>
            <p className="text-sm text-slate-400 leading-relaxed">
              An annual intra-department programming competition organized by the Department of Computer Science &amp; Engineering, GSTU.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 text-sm">
            <div className="space-y-1 text-slate-400">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="mailto:cse@gstu.ac.bd" className="hover:text-white transition-colors">
                  cse@gstu.ac.bd
                </a>
              </div>
            </div>
