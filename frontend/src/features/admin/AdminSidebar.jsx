      ...
      <div>
        <div className="hidden md:block mb-8">
          {!isCollapsed ? (
            ...
            <Link to="/" className="text-2xl font-black tracking-tighter block hover:opacity-90 text-center">
              G<span className="text-blue-500">A</span>
            </Link>
          )}
        </div>

        <nav className="grid grid-cols-5 gap-1 md:flex md:flex-col md:space-y-1">
          {navItems.map((item) => {
