            ...
            {isEditingRepo ? (
              <form onSubmit={handleSaveRepo} className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  className="w-full sm:flex-1 px-4 py-3 rounded-xl border border-slate-300 focus:ring-2 focus:ring-blue-500 outline-none"
                />
                <div className="flex gap-2">
                  <button
                    type="submit"
                    className="flex-1 sm:flex-initial px-6 py-3 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition-colors"
                  >
                    Save
                  </button>
                  <button
                    ...
                    className="flex-1 sm:flex-initial px-6 py-3 bg-slate-100 text-slate-700 font-bold rounded-xl hover:bg-slate-200 transition-colors"
                  >
                    Cancel
                  </button>
                </div>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 p-4 rounded-2xl bg-slate-50 border border-slate-200 overflow-hidden w-full">
                <div className="flex items-center gap-3 min-w-0 w-full sm:w-auto overflow-hidden">
                  ...
                  <a href={repoUrl} target="_blank" rel="noreferrer" className="font-mono text-xs sm:text-sm text-blue-600 hover:underline truncate block min-w-0">
                    {repoUrl}
                  </a>
                </div>
                <button
                  onClick={() => setIsEditingRepo(true)}
                  className="px-4 py-2 text-sm font-bold text-slate-700 bg-white border border-slate-300 rounded-xl hover:bg-slate-50 flex-shrink-0"
                >
                  Edit URL
                </button>
              </div>
